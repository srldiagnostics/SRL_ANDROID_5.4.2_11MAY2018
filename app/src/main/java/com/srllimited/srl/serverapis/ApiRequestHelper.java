...
import static com.srllimited.srl.serverapis.ApiRequestReferralCode.GET_PackageRecommendation;
...
import static com.srllimited.srl.serverapis.ApiRequestReferralCode.GetRelationShip;
...
import static com.srllimited.srl.serverapis.ApiRequestReferralCode.Get_SurveyCity;
import static com.srllimited.srl.serverapis.ApiRequestReferralCode.Get_SurveyForFamily;
...
public class ApiRequestHelper {
    ...
    public static ApiRequest getSRLRecommendationPackageDetails(Context context, String ptntcode,
                                               String mobileno) {
        Map<String, String> params = ApiParameters.passGetSRLREcommPackageDetails(ptntcode, mobileno);

        ApiRequest request = new ApiRequest(GET_PackageRecommendation, ApiConstants.getSRLREcommPackageDetailsUrl);
        if (Constants.isTOKENAPI) {
            request.setParams(Utility.EncreptWithTwoParam(context,ptntcode, mobileno, params));
        } else {
            request.setParams(params);
        }
        return request;
    ...
    public static ApiRequest getsurvey(Context context, String ptntcode, String mobileno,String relation,String family_ptntcd) {
        Map<String, String> params = ApiParameters.getsurveys(ptntcode, mobileno,relation,family_ptntcd);
    ...
    public static ApiRequest getsurveyCity(Context context) {
        Map<String, String> params = ApiParameters.getsurveysCity();

        ApiRequest request = new ApiRequest(Get_SurveyCity, ApiConstants.GetSurveyCityUrl);
        if (Constants.isTOKENAPI) {
    ...
    public static ApiRequest getSurveyForFamily(Context context, String ptntcode, String mobileno) {
        Map<String, String> params = ApiParameters.getfamilysurveys(ptntcode, mobileno);

        ApiRequest request = new ApiRequest(Get_SurveyForFamily, ApiConstants.GetSurveyForFamily);
        if (Constants.isTOKENAPI) {
            request.setParams(Utility.EncreptWithTwoParam(context,ptntcode, mobileno, params));
            //  request.setParams(Utility.EncreptWithOneParam(ptntcode, params)); //grptype always 1
        } else {
    ...
    public static ApiRequest getRelationShip(Context context) {
        Map<String, String> params = new HashMap<>();

        ApiRequest request = new ApiRequest(GetRelationShip, ApiConstants.GetRelationShipUrl);
        if (Constants.isTOKENAPI) {
            request.setParams(Utility.EncreptWithdefaultParam(context,params));
            //  request.setParams(Utility.EncreptWithOneParam(ptntcode, params)); //grptype always 1
        } else {
