...
public class ApiParameters
{
	...
	public static Map<String, String> passGetSRLREcommPackageDetails(String ptncode, String mobileno)
	{
		Map<String, String> params = new HashMap<String, String>();
		params.put("ptntcd", ptncode);
			...
			String mysrl_version)
	{
		...
		{
			params.put("survey_flag", "Y");
		}
		else
		{
			params.put("survey_flag", "");
		}
	...
	public static Map<String, String> getsurveys(String ptntcode,String mobileno,String relation,String familymem_ptntcd)
	{
		Map<String, String> params = new HashMap<String, String>();
		...
		params.put("relation_ptnt_id",familymem_ptntcd);
		params.put("relation",relation);
		return params;
	}

	public static Map<String, String> getsurveysCity()
	{
		Map<String, String> params = new HashMap<String, String>();
		params.put("survey_id", "1");

		return params;
	}
	public static Map<String, String> getfamilysurveys(String ptntcode,String mobileno)
	{
		Map<String, String> params = new HashMap<String, String>();
		params.put("ptntcd", ptntcode);
		params.put("mobileno", mobileno);
		params.put("deviceid", Constants.devicetobepassed);
		params.put("ostype", "ANDROID");
		/*params.put("P_OSVERSION", ApiConstants.osVersion);
		params.put("P_MYSRL_VERSION", ApiConstants.appVersion);
		params.put("relation",relation);*/
