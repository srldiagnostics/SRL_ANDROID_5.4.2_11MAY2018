...
public enum ApiRequestReferralCode {
    PAY(1), USER(2), LOGIN(3), ORDERS(4), GET_PDF(5), MY_CART(6), REPORTS(7), GET_PROMO(8), RESEND_OTP(9), FORGOT_PWD(
            ...
            47),
    GET_CONTACT_US(48),
    GET_Paytm_checksum(49),ValidateRegistration_Family(50),Get_SURVEY(51),Validate_MobileNo(52),Authenticate_MobileNo(53),Family_Member_Mapping(54),Display_Family_Member(55),ResendOTP_Mobile(56),GetRelationShip(57),Get_SurveyForFamily(58),Get_SurveyCity(59),GET_PackageRecommendation(60);
