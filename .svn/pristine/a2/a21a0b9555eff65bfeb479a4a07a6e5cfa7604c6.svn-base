...
import com.srllimited.srl.database.DatabaseRecomondHelper;
...
public class TestRecommondationAdapter extends RecyclerView.Adapter<TestRecommondationAdapter.ViewHolder>
{
	public static NotifyActivity notifyActivity;
	public static boolean isRemoveitem = false;
	DatabaseRecomondHelper db;
	...
	private List<TestRecomandData> mBook_A_Test_Data;
	private boolean mIsCart = false;

	public TestRecommondationAdapter(Context context, List<TestRecomandData> bookatestdata, boolean isCart)
	{
		this.mContext = context;
		this.mIsCart = isCart;
		this.mBook_A_Test_Data = bookatestdata;
		this.db = new DatabaseRecomondHelper(context);
	...
	@Override
	public TestRecommondationAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, final int i)
	{
		View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.test_recomondation_item, viewGroup, false);
		return new ViewHolder(view);
	}

	@Override
	public void onBindViewHolder(final TestRecommondationAdapter.ViewHolder viewHolder, final int i)
	{
		if (viewHolder != null)
		{
			if (mBook_A_Test_Data.get(i) != null)
			{
				...
				if (mBook_A_Test_Data.get(i).getPRICE() != 0 )
				{
	...
	{
		void onChangingListItem(List<TestRecomandData> bookTestORPackagesDatas);
	}

	public class ViewHolder extends RecyclerView.ViewHolder
	{

		TextView book_test_name;
		TextView book_original_price;
		TextView lblprice;
		TextView txtdescr;
		...
		public ViewHolder(View view)
		{
			...
			txtdescr=(TextView)view.findViewById(R.id.txtdescr);
