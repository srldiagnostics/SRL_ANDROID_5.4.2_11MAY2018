...
import com.srllimited.srl.adapters.FamilymemberListAdapter;
...
public class Dashboard extends MenuBaseActivity implements View.OnClickListener {
    ...
    private static final int RESULT_CODE_SEARCH_SURVEY_LOCATION = 10;
    ...
    Dialog dialog;
    String relation = "";
    public static String selectedfamilymember = "";
    //	private ImageView mFooterArrow, mHeaderLocDropdown;
    //	private View mFooterOptions;
    String familypatitfirstname = "", familypatitlastname = "", familypatientgender = "", familypatientdob = "", familypatientemailid = "";
...
//////////////////////////////////////////////////////////
                    ...
                    //   Util.clearRecomondationCart(context);
                    //////////////////////////////////////////////////////////
                    ...
                    if (Util.isCity(context)) {
                        ...
                        Constants.issrlRecommondation = false;
            ...
            if (intent.getAction().equals(mBroadcasActionNot)) {
                ...
                try {
                    ...
                    if (displayNotification != 0) {
                        ...
                        } else notification_count.setVisibility(View.GONE);
                    } else notification_count.setVisibility(View.GONE);
                } catch (Exception e) {
        ...
        public void onResponse(final ApiRequest request, final ServerResponseData mserverResponseData) {
            ...
            if (mserverResponseData != null) {
                switch (request.getReferralCode()) {
                        ...
                        if (Validate.notEmpty(allCitylist)) {
                            ...
                            for (CityListData cityListData : allCitylist) {
                                ...
                                if (cityListData.getCITY_NAME().toUpperCase().contains(cityn.toUpperCase())) {
                                    ...
                                    SharedPrefsUtil.setStringPreference(context, "selectedcityid", cityListData.getCITY_ID() + "");
                                    SharedPrefsUtil.setStringPreference(context, "selectedcity", cityListData.getCITY_NAME().toString());
                                    SharedPrefsUtil.setStringPreference(context, "displayname", cityListData.getDISPLAY_NAME().toString());
                                    new CarouselsTask(getApplicationContext());
                                    break;
                                } else if (cityListData.getALIASES() != null && cityListData.getALIASES().toUpperCase().contains(cityn.toUpperCase())) {
                    ...
                    case Get_SurveyCity:
                        // sfdsgdfgfgfh
                        String mssge1 = mserverResponseData.getMsg();
                        if (mssge1.equalsIgnoreCase("Query Successful")) {
                            //setCitySurveyAlertDialog(false, mserverResponseData.getFullData());
                            JSONObject jsonobject = mserverResponseData.getObjectData();
                            JSONArray jsonArray = null;
                            try {
                                jsonArray = jsonobject.getJSONArray("SURVEY_CITIES");
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                            final List<String> relationarray = new ArrayList<>();
                            for (int i = 0; i < jsonArray.length(); i++) {
                                try {
                                    relationarray.add(jsonArray.getJSONObject(i).getString("NAME"));
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            }
                            ...
                            dialog.setContentView(R.layout.relation_popup);
                            ...
                            final ListView recycler_view = (ListView) dialog.findViewById(R.id.recycler_view);

                            txtmsg.setText("Select Relation");


                            ArrayAdapter<String> mAdapter = new ArrayAdapter<String>(Dashboard.this, android.R.layout.simple_list_item_1, relationarray);
                            recycler_view.setAdapter(mAdapter);
                            mAdapter.notifyDataSetChanged();
                            /*recycler_view.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                @Override
                                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                    selectedsurvrycity =relationarray.get(i).toString();
                                }
                        ...
                        break;
                    case Get_SURVEY: {
                        //android.util.Log.e("TAG12", String.valueOf(mserverResponseData.getArrayData()) + " " + request.getReferralCode());

                        if (mserverResponseData.getMsg().equalsIgnoreCase("SUCCESS")) {

                            if (Dashboard.selectedfamilymember.equalsIgnoreCase("")) {
                            ...
                            if (_userAppData1.getGender() != null && !_userAppData1.getGender().equalsIgnoreCase("null")) {
                                if (_userAppData1.getGender().equalsIgnoreCase("F")) {
                                    gendervalue = "female";
                                }
                                if (_userAppData1.getGender().equalsIgnoreCase("M")) {
                                    gendervalue = "male";
                                }
                            }
                            String url = "";
                            String age = "";
                            String dateofbirth = Html.fromHtml(DateUtil.epochToDate(_userAppData1.getDob())) + "";
                            if (!selectedfamilymember.equalsIgnoreCase("")) {
                                String dateofbirtharray[] = familypatientdob.split("-");
                                age = getAge(Integer.valueOf(dateofbirtharray[2]), Integer.valueOf(dateofbirtharray[1]), Integer.valueOf(dateofbirtharray[0]));

                                if (familypatientemailid == null) {
                                    familypatientemailid = "";
                                }
                                //dev     url = ApiConstants.SURVEY_URL+"/smartselect?patient_code=" + selectedfamilymember + "&first_name=" + familypatitfirstname + "&last_name=" + familypatitlastname + "&mobile=" + _userAppData1.getMobile_no() + "&email=" + familypatientemailid + "&gender=" + familypatientgender + "&age=" + age + "&date_of_birth=" + familypatientdob + "&city=" + selectedsurvrycity + "";

                                //production
                                url = ApiConstants.SURVEY_URL+"/smartselect?patient_code=" + selectedfamilymember + "&first_name=" + familypatitfirstname + "&last_name=" + familypatitlastname + "&mobile=" + _userAppData1.getMobile_no() + "&email=" + familypatientemailid + "&gender=" + familypatientgender + "&age=" + age + "&date_of_birth=" + familypatientdob + "&city=" + selectedsurvrycity + "";
                                //   https://srlcare.srl.in/smartselect?patient_code=TESTF2704620&first_name=known usrflow&last_name=test&mobile=9029372394&email=knownflow@gmail.com&gender=female&age=55&date_of_birth=28-02-1962&city=Mumbai
                            } else {
                                String dateofbirtharray[] = dateofbirth.split("-");
                                age = getAge(Integer.valueOf(dateofbirtharray[2]), Integer.valueOf(dateofbirtharray[1]), Integer.valueOf(dateofbirtharray[0]));
                                if (_userAppData1.getEmail_id().equalsIgnoreCase("null")) {
                                    familypatientemailid = "";
                                } else {
                                    familypatientemailid = _userAppData1.getEmail_id();
                                }
                                    //dev
                                 // url = ApiConstants.SURVEY_URL+"/smartselect?patient_code=" + Util.getStoredUsername(context) + "&first_name=" + _userAppData1.getFirst_name() + "&last_name=" + _userAppData1.getLast_name() + "&mobile=" + _userAppData1.getMobile_no() + "&email=" + familypatientemailid  + "&gender=" + gendervalue + "&age" + age + "&date_of_birth=" + dateofbirth + "&city=" + selectedsurvrycity + "";
                            ...
                            if (Integer.parseInt(age) < 18 || Integer.parseInt(age) > 80) {
                                Toast.makeText(Dashboard.this, "Age should be between 18 to 80 years", Toast.LENGTH_LONG).show();
                            } else {
                                Intent labintent = new Intent(context, HealthSurvey_activity.class);


                                labintent.putExtra("url", url);
                                startActivity(labintent);
                            }
                        }
                        //if (mserverResponseData.getMsg().equalsIgnoreCase("SURVEY ALREADY TAKEN"))
                        else {

                            if(mserverResponseData.getMsg().equalsIgnoreCase("SURVEY ALREADY TAKEN") &&(!Dashboard.selectedfamilymember.equalsIgnoreCase(""))){
                            ...
                            ////////
                            List<UserData> familylist = appDb.getUSersList();

                            List<UserData> mUSerData = new ArrayList<>();
                            for (UserData bookdata : familylist) {
                                if (bookdata.getStatus().equalsIgnoreCase("false")) {
                                    mUSerData.add(bookdata);
                                } else {
                                }
                            }
                            android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Dashboard.this, android.app.AlertDialog.THEME_HOLO_LIGHT);
                            if (mUSerData.size() > 0) {

                                sendRequest(ApiRequestHelper.getSurveyForFamily(context, Util.getStoredUsername(context), _userAppData.getMobile_no()));

                            } else {

                                builder.setMessage("SURVEY ALREADY TAKEN").setCancelable(false).setNegativeButton("Take Survey Again", new DialogInterface.OnClickListener() {
                    ...
                    break;
                    case Get_SurveyForFamily: {

                        String mssge = mserverResponseData.getMsg();
                        final List<UserData> patientDetailsDatas = new ArrayList<>();
                        if (mssge.equalsIgnoreCase("Query Successful")) {
                            JSONObject jsonObject = mserverResponseData.getFullData();
                            JSONArray jArray = null;

                            try {
                                if (!jsonObject.isNull("data")) {
                                    JSONObject obj = jsonObject.getJSONObject("data");
                                    Object objprimary = obj.get("SURVEY");
                                    if (objprimary != null && objprimary instanceof JSONArray) {
                                        jArray = obj.getJSONArray("SURVEY");
                                    }
                                }


                                for (int i = 0; i < jArray.length(); i++) {
                                    UserData patientDetailsData = new UserData();
                                    patientDetailsData.setParent_id(jArray.getJSONObject(i).getString(Constants.ptntCd1));
						...
						patientDetailsData.setSTATE(jArray.getJSONObject(i).getString(Constants.state1))*/
                                    ...
                                    patientDetailsData.setGender(jArray.getJSONObject(i).getString(Constants.gender));
                                    try {

                                        patientDetailsData.setDob(Long.valueOf(jArray.getJSONObject(i).getLong("DOB")));
                                    } catch (Exception e) {

                                    }
                                    patientDetailsDatas.add(patientDetailsData);
                                }
                            ...
                            ///
                          /*  android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Dashboard.this, android.app.AlertDialog.THEME_HOLO_LIGHT);
                            builder.setMessage("SURVEY ALREADY TAKEN").setCancelable(false).setNegativeButton("Done", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                }
                            }).setPositiveButton("Take Survey for family", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    // gfhgdfghhhg
                                    if (patientDetailsDatas.size() <= 0) {
                                        Toast.makeText(Dashboard.this, "Survey Already Completed For All Family Membres", Toast.LENGTH_LONG).show();
                                    } else {
                                        getPatientDetail(patientDetailsDatas);
                                    }
                                }
                            });
                            alert = builder.create();
                            ...
                            ///////////////custome alert/////
                            final Dialog promoDialog = new Dialog(context);
                            ...
                            promoDialog.setContentView(R.layout.survey_us_pop_alert);
                            TextView selfsurvey = (TextView) promoDialog.findViewById(R.id.selfsurvey);
                            TextView familysurvey = (TextView) promoDialog.findViewById(R.id.familysurvey);
                            ImageView imgclose= (ImageView) promoDialog.findViewById(R.id.imgclose);

                            selfsurvey.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                            ...
                            familysurvey.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    promoDialog.dismiss();
                                    if (patientDetailsDatas.size() <= 0) {
                    ...
                    case GetRelationShip:
                        if (mserverResponseData.getMsg().equalsIgnoreCase("Query Successful")) {
                            JSONArray jsonArray = mserverResponseData.getArrayData();

                            List<String> relationarray = new ArrayList<>();
                            for (int i = 0; i < jsonArray.length(); i++) {
                                try {
                                    relationarray.add(jsonArray.getJSONObject(i).getString("DESCRIPTION"));
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            }
                            getRelation(relationarray, jsonArray, selectedfamilymember);
                        }
                        break;
                }
                //  allCitylist = parseCityList(mserverResponseData.getFullData());
    ...
    private void getPatientDetail(List<UserData> patientDetailsDatas) {
        // Create custom dialog object
        // List<PatientDetailsData> patientDetailsDatas= new ArrayList<>();
        dialog = new Dialog(Dashboard.this);
        // Include dialog.xml file
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.surveyfamilylist_lyt);
        dialog.setCancelable(false);
        // Set dialog title
        // dialog.setTitle("Custom Dialog");
        //
        ...
        txtmsg.setText("Following are the Family members list \n please select family memebr for survey. ");
        ...
        FamilymemberListAdapter mAdapter = new FamilymemberListAdapter(context, patientDetailsDatas);
        recycler_view.setAdapter(mAdapter);
        mAdapter.notifyDataSetChanged();
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.dismiss();
                try {
                    selectedfamilymember = FamilymemberListAdapter.patientDetailsDataobj.getParent_id();
                    familypatitfirstname = FamilymemberListAdapter.patientDetailsDataobj.getFirst_name();
                    familypatitlastname = FamilymemberListAdapter.patientDetailsDataobj.getLast_name();

                    if (FamilymemberListAdapter.patientDetailsDataobj.getGender().equalsIgnoreCase("F")) {
                        familypatientgender = "female";
                    }
                    if (FamilymemberListAdapter.patientDetailsDataobj.getGender().equalsIgnoreCase("M")) {
                        familypatientgender = "male";
                    }

                    familypatientdob = Html.fromHtml(DateUtil.epochToDate(FamilymemberListAdapter.patientDetailsDataobj.getDob())) + "";
                    familypatientemailid = FamilymemberListAdapter.patientDetailsDataobj.getEmail_id();

                    SharedPrefsUtil.setStringPreference(context, "selectedPerson", selectedfamilymember + "");
                    SharedPrefsUtil.setStringPreference(context, "selectedName", familypatitfirstname + " " + familypatitlastname + "");
                    Constants.isPatientDetails = false;
                    Constants.isFamilySel = true;


                    sendRequest(ApiRequestHelper.getRelationShip(context));
                } catch (Exception e) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Constants.devicetobepassed = Settings.Secure.getString(getApplicationContext().getContentResolver(), Settings.Secure.ANDROID_ID);
        } catch (Exception e) {
        ...
        if (getIntent().hasExtra("callcityforsurvey")) {

            Dashboard.selectedfamilymember = "";
            setCitySurveyAlertDialog(true);
		...
		*/
        ...
        if (Validate.notEmpty(splash) && splash.equalsIgnoreCase("true")) {
            if (header_loc_name.getText().toString().equalsIgnoreCase("select a city") && !LocationHandler.canGetLocation(context)) {
                showSettingsAlert();
            }
        }
    ...
    private void getRelation(final List<String> relationlist, final JSONArray jsonArray, final String familyid) {
        // Create custom dialog object
        // List<PatientDetailsData> patientDetailsDatas= new ArrayList<>();
        dialog = new Dialog(Dashboard.this);
        // Include dialog.xml file
...
for(int i=0;i<30;i++) {
    ...
    patientDetailsDatas.add(patientDetailsData1);
        ...
        ArrayAdapter<String> mAdapter = new ArrayAdapter<String>(Dashboard.this, android.R.layout.simple_list_item_1, relationlist);
        recycler_view.setAdapter(mAdapter);
        mAdapter.notifyDataSetChanged();
        ...
        recycler_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    relation = jsonArray.getJSONObject(i).getString("CD");
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Close dialog
                dialog.dismiss();
                sendRequest(ApiRequestHelper.getsurvey(context, Util.getStoredUsername(context), _userAppData.getMobile_no(), relation, familyid));
            }
        });
        dialog.show();
    }
    ...
    private void init() {
        ...
        StikkyHeaderBuilder.stickTo(mRecyclerView).setHeader(R.id.header, mRootViewGroup).minHeightHeaderDim(R.dimen.min_height_header).build();
    ...
    protected void onResume() {
        ...
        if (Validate.notEmpty(city)) header_loc_name.setText(city);
        if (LocationHandler.canGetLocation(context)) {
    ...
    private void navigateToHealth() {
        ...
        SharedPrefsUtil.setIntegerPreference(context, Constants.sharedPreferenceSelectedLoginActivity, Constants.m_health);
        if (Util.getStoredUsername(context) != null && !Util.getStoredUsername(context).isEmpty() && !Util.isRem(context)) {
            Util.killHealthTrack();
    ...
    protected void onStart() {
        ...
        SharedPrefsUtil.setIntegerPreference(context, Constants.sharedPreferenceSelectedLoginActivity, Constants.m_login);
    }
    ...
    private void showSettingsAlert() {
        ...
        builder.setMessage("Location Services Disabled").setPositiveButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
    ...
    private void handleTaskWithUserPermission(int requestCode, final String phn) {
        DangerousPermissionUtils.getPermission(context, new String[]{Manifest.permission.CALL_PHONE, Manifest.permission.READ_PHONE_STATE}, requestCode).enqueue(new DangerousPermResponseCallBack() {
            @Override
            public void onComplete(final DangerousPermissionResponse permissionResponse) {
                if (permissionResponse.isGranted()) {
                    if (permissionResponse.getRequestCode() == PHONE_REQUES_CODE) {
                        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(context, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                            return;
                        }
            ...
            try {
                if (Validate.notNull(jArray)) {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        if (jArray.getJSONObject(i).getString("BANNER_FLG") != null && jArray.getJSONObject(i).getString("BANNER_FLG").equalsIgnoreCase("Y")) {
                            if (jArray.getJSONObject(i).getString("IMAGE_URL") != null) {

                                SharedPrefsUtil.setIntegerPreference(context, "carouselcount", count);
                                SharedPrefsUtil.setStringPreference(context, "carouselimg" + count + "", jArray.getJSONObject(i).getString("IMAGE_URL"));
                                count++;
                            }
                        }
                    }
    ...
    private void setCitySurveyAlertDialog(boolean isLaunched) {

        Util.killSearchLoc();
        Intent intent = new Intent(this, searchsurveylocationActivity.class);
        intent.putExtra("isLaunched", true);
        startActivityForResult(intent, RESULT_CODE_SEARCH_SURVEY_LOCATION);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_CODE_SEARCH_SURVEY_LOCATION) {
            if (requestCode == 10) {
                try {
                    _userAppData = appDb.getSelectedUserDetail(Util.getStoredUsername(context));
                    CityListData selectedCity = (CityListData) data.getSerializableExtra(SearchLocationActivity.EXTRA_PARAM_DATA);
                    selectedsurvrycity = selectedCity.getCITY_NAME();
                    sendRequest(ApiRequestHelper.getsurvey(context, Util.getStoredUsername(context), _userAppData.getMobile_no(), "", ""));
            ...
            public void onClick(int position) {
                ...
                if (Validate.notEmpty(screen)) {
                 ...
                 /*   if (Util.getStoredUsername(context) != null && !Util.getStoredUsername(context).isEmpty()
                            && !Util.isRem(context)) {
                        _userAppData = appDb.getSelectedUserDetail(Util.getStoredUsername(context));
                        String lointype = Util.getStoredlointype(context);

                        Dashboard.selectedfamilymember="";
                        setCitySurveyAlertDialog(false);



                    } else {

                        LoginScreenActivity.commimgfromsurvey = "yes";
                        Intent labintent = new Intent(context, LoginScreenActivity.class);
                        startActivity(labintent);
                    }*/
    ...
    private void naviagteToBannerScreen(String screen) {
        ...
        if (screen.equalsIgnoreCase("SURVEY")) {
            ...
            if (Util.getStoredUsername(context) != null && !Util.getStoredUsername(context).isEmpty() && !Util.isRem(context)) {
                ...
                SharedPrefsUtil.setIntegerPreference(context, Constants.sharedPreferenceSelectedLoginActivity, Constants.m_selectcityforsurvey);
                LoginScreenActivity.commimgfromsurvey = "yes";
                Intent labintent = new Intent(context, LoginScreenActivity.class);
                startActivity(labintent);
            }
    ...
    private void navigateTomyfamily() {
        SharedPrefsUtil.setIntegerPreference(context, Constants.sharedPreferenceSelectedLoginActivity, Constants.m_family);
        if (Util.getStoredUsername(context) != null && !Util.getStoredUsername(context).isEmpty() && !Util.isRem(context)) {
            Util.killMyFamily();
            Constants.isFamilySel = false;
    ...
    private void playStroreAccess() {
        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.srllimited.srl"));
        startActivity(i);
    }
    ...
    */
    public void showSkipAlert() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Dashboard.this, android.app.AlertDialog.THEME_HOLO_LIGHT);
        builder.setMessage("Skipping the PIN security may lead to unauthorized access.Do you still want to skip?").setCancelable(false).setPositiveButton("No", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
    ...
    private void notificationAlert(final String type, String buttontype, String title, String Msg) {
        final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(this, AlertDialog.THEME_HOLO_LIGHT);
