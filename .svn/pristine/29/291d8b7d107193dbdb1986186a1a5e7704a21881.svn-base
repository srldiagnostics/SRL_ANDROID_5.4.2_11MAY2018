	...
	private void navigateToActivity()
	{
		...
		switch (navigationcount)
		{
			...
			case Constants.m_recommondedpck:
				...
				Util.killBook();
				Intent i= new Intent(FourDigitActivity.this, BookATestActivity.class);
				startActivity(i);
				finish();
				break;
				case Constants.m_selectcityforsurvey:
					Util.killDashBoard();
					intent = new Intent(FourDigitActivity.this, Dashboard.class);
					intent.putExtra("callcityforsurvey","callcityforsurvey");
					break;
