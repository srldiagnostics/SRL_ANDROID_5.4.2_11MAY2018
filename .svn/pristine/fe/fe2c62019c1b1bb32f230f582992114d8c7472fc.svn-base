...
public class BookTestORPackagesData
{
	...
	public static BookTestORPackagesData newInit(final JSONObject jsonObject)
	{
		...
		try
		{
			...
			try
			{
				booktest_or_pkgs.setPKG_CATEGORY(jsonObject.getString(Constants.booktest_PKG_CATEGORY));
			}
			catch (Exception e)
			{
				e.printStackTrace();
	...
	public String getPKG_CATEGORY() {
		return PKG_CATEGORY;
	}

	public void setPKG_CATEGORY(String PKG_CATEGORY) {
		this.PKG_CATEGORY = PKG_CATEGORY;
	}
