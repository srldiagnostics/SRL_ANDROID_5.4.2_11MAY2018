...
public class SearchLocationViewForSurvey extends FrameLayout
{
	...
	public SearchLocationViewForSurvey(Context context)
	{
		this(context, null);
	}

	public SearchLocationViewForSurvey(Context context, AttributeSet attrs)
	{
		this(context, attrs, 0);
	}

	public SearchLocationViewForSurvey(Context context, AttributeSet attrs, int defStyleAttr)
	{
	...
	public SearchLocationViewForSurvey(final Context context, final AttributeSet attrs, final int defStyleAttr,
	...
	private void init(Context context, AttributeSet attrs, int defStyleAttr)
	{
		...
		mSearchView.getEditText().setHint(getResources().getString(R.string.search_bar_city_hint));
			...
			mHeading.setText("Select City for Survey");
