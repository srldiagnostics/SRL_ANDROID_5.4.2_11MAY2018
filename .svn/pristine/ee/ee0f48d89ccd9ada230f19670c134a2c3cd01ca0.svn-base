...
public class ApiConstants {
    public static final String appVersion = "5.4.2";//Changed As per Mail Thu 1/11/2018 5:51 PM
...
// quility
 ...
 private static final String ipAddress2 = "http://srldiagapp.mysrl.in:92/service.asmx";*/
  ...
  //PRODUCTION
    public static final String SURVEY_URL ="http://srlcare.srl.in";

    //DEVELOPMENT
   // public static final String SURVEY_URL ="http://svasth09.southeastasia.cloudapp.azure.com";
    ...
    public static final String getSRLREcommPackageDetailsUrl = ipAddress + "/PackageRecommendation";
   ...
   // public static final String getPayUrl = ipAddress + "/CreateOrder_Guest";
    public static final String getPayUrl = ipAddress + "/CreateOrder_Guest_Survey"; //production only
    ...
    public static final String GetSurveyCityUrl = ipAddress2 + "/Survey_city";
    public static final String GetSurveyForFamily=ipAddress2 + "/SurveyForFamily";
    public static final String GetRelationShipUrl = ipAddress2 + "/GetRelationShip";
